...
public class DataBaseContent {
    ...
    public void createUsersInDataBase() {
        users.put("vdk64",userRepo.save(User.builder()
                .username("vdk64")
                .firstname("Дмитрий")
                .lastname("Вознюк")
        ...
        users.put("user", userRepo.save(User.builder()
                .username("user")
                .firstname("Ivan")
                .lastname("Petrov")
                .password(passwordEncoder.encode("a"))
        ...
        users.put("kasha111", userRepo.save(User.builder()
                .username("kasha111")
                .firstname("Аркадий")
                .lastname("Ротенберг")
                .password(passwordEncoder.encode("a"))
        ...
        users.put("tony64", userRepo.save(User.builder()
                .username("tony64")
                .firstname("Антон")
                .lastname("Васильев")
                .password(passwordEncoder.encode("a"))
